...
import {
  ...
  Color,
  StyleVariable,
} from "../../../frontend/constants/GlobalStyles";

export default function friends() {
  return (
    <ParallaxScrollView
      headerBackgroundColor={{ light: "transparant", dark: "transparant" }}
      headerImage={
        <LinearGradient
      ...
      <View style={styles.friends}>
        ...
        <View style={styles.oweGroup}>
          ...
          <View style={[styles.list3, styles.listLayout]}>
            ...
            <Text style={[styles.youoweOrOwes1, styles.namePosition]}>
              Owes you
            </Text>
          ...
          <View style={[styles.list2, styles.listLayout]}>
            ...
            <Text
              style={[styles.youoweOrOwes2, styles.namePosition]}
            >{`Owes you `}</Text>
            <FontAwesome
              name="user-circle"
              size={40}
              ...
              style={styles.icon}
            />
            <Text style={[styles.name2, styles.namePosition]}>
              Suvanaga Dhakal
            </Text>
          </View>
          <View style={[styles.list1, styles.list1Position]}>
            ...
            <Text style={[styles.youoweOrOwed, styles.name3Position1]}>
              You owe
            </Text>
            <FontAwesome
              name="user-circle"
              ...
              style={styles.icon}
            />
            <Text style={[styles.name3, styles.name3Position]}>
              Bishnu Pokaral
            </Text>
          </View>
        </View>
